        ...
        <div id="firstPageAdmin">
            <div class="container mt-5 text-center">
                ...
                <form class="modal-content animate mt-5" action="index?akcja=zablokuj" method="post">
                    ...
                    <input type="text" class="my-2 col-4 offset-4" placeholder="Wprowadź login usera" name="zablokujLog" required/><br>
            ...
            <div class="container mt-5 text-center">
                ...
                <form class="modal-content animate mt-5" action="index?akcja=query" method="post">
